...
const PendingLeaves = (props) => {
    ...
    const getPendingLeaves = ()=>{
        ...
        return fetch("https://deploy-backend-hr-management.onrender.com/api/leave/pending_all",{
            method:"GET",
            headers:{
                "Authorization":token
            }
    ...
    const getLeaveDetail =(id)=>{
        let token = JSON.parse(localStorage.getItem("token")).token;
        return fetch(`https://deploy-backend-hr-management.onrender.com/api/leave/${id}`,{
            method:"GET",
            headers:{
                "Authorization":token
            }
    ...
    const approvingLeave=(id)=>{
        return fetch(`https://deploy-backend-hr-management.onrender.com/api/leave/approve/${id}`,{
            method:"POST",
            headers:{
    ...
    const rejectingLeave=(id)=>{
        return fetch(`https://deploy-backend-hr-management.onrender.com/api/leave/reject/${id}`,{
            method:"POST",
            headers:{
                "Authorization":JSON.parse(localStorage.getItem("token")).token,
                "Content-Type":"application/json"
